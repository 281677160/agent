...
echo
echo -e "\033[32m vless://${MSID}@${getIpAddress}:${PORT}?headerType=none&type=tcp&encryption=none&flow=xtls-rprx-direct&security=xtls&sni=${wzym}#VLESS+TCP+XTLS \033[0m"
echo
...
echo
echo -e "\033[32m vless://${MSID}@${wzym}:${PORT}?headerType=none&type=tcp&encryption=none&security=tls&sni=${wzym}#VLESS+TPC+TLS \033[0m"
echo
...
echo
echo -e "\033[32m vless://${MSID}@${wzym}:${PORT}?host=&path=%2F${WEBS}&type=ws&encryption=none&security=tls&sni=${wzym}#VLESS+WS+TLS \033[0m"
echo
echo -e "\033[33m 节点备注/别名：VLESS+TPC+TLS（可自行修改） \033[0m"
echo -e "\033[33m 节点类型：V2Ray/XRay \033[0m"
echo -e "\033[33m 协议：V2Ray/XRay \033[0m"
