...
echo
echo -e "\033[34m 请输入您的前端网页域名[比如：sub.v2rayssr.com] \033[0m"
read -p " 请输入您的前端网址域名：" wzym
export wzym=${wzym}
echo -e "\033[32m 您的前端网址域名为：${wzym} \033[0m"
echo
echo
echo -e "\033[34m 请输入您的后端服务地址域名[比如：suc.v2rayssr.com] \033[0m"
read -p "请输入您的后端服务地址域名：" fwym
export fwym=${fwym}
echo -e "\033[32m 您的后台地址为：${fwym} \033[0m"
echo
sleep 20
