...
qrCodeBase64Default=$(echo -n "{\"port\":${PORT},\"ps\":\"${domain}\",\"tls\":\"tls\",\"id\":\"${UUID}\",\"aid\":0,\"v\":2,\"host\":\"${domain}\",\"type\":\"none\",\"path\":\"\${VMWS}\\",\"net\":\"ws\",\"add\":\"${domain}\",\"allowInsecure\":0,\"method\":\"none\",\"peer\":\"${domain}\",\"sni\":\"ws${domain}\"}" | base64 -w 0)
